...
from web.services.tool_service import TOOL_MAPPING
...
# Mock billing endpoint for private deployment - always returns high balance
@router.get("/billing/getBalance")
async def get_balance():
    return {"balance": "999999.99"}
