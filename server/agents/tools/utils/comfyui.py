...
from web.services.comfyui_execution_service import execute
from agents.tools.video_generation.video_canvas_utils import get_video_info_and_save
...
def get_asset_path(filename):
    ...
    return os.path.join(base_path, "agents", "workflow", filename)
