...
class TestVideoCanvasUtilsImports:
    def test_canvas_lock_manager_exists(self):
        from agents.tools.video_generation.video_canvas_utils import CanvasLockManager
...
class TestVideoCanvasUtilsFunctions:
    def test_save_video_to_canvas_function_exists(self):
        from agents.tools.video_generation.video_canvas_utils import save_video_to_canvas
