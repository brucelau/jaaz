...
class TestToolConfirmationRouter:
    ...
    def mock_services(self):
        with patch('routers.tool_confirmation_router.tool_confirmation_manager') as mock_mgr, \
             patch('routers.tool_confirmation_router.send_to_websocket') as mock_ws:
    ...
    def test_confirm_tool_success(self, mock_services):
        from routers.tool_confirmation_router import router
