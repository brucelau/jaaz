...
class TestWebsocketsManager:
    def test_add_connection(self):
        from web.websocket.manager import add_connection, active_connections
    ...
    def test_remove_connection(self):
        from web.websocket.manager import add_connection, remove_connection, active_connections
        add_connection('test_sid', {'user': 'test'})
        remove_connection('test_sid')
        assert 'test_sid' not in active_connections

    def test_get_all_socket_ids(self):
        from web.websocket.manager import add_connection, get_all_socket_ids
    ...
    def test_get_connection_count(self):
        from web.websocket.manager import add_connection, remove_connection, get_connection_count
        add_connection('sid1', {})
        add_connection('sid2', {})
